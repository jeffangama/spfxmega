...
/**
 * The states for our intetnal state machine that manages dialogs
 *
 * @internal
 */
...
declare abstract class BaseDialog {
     ...
     *
     * It is important to keep the constructor lightweight. Use onBeforeOpen() for doing heavy-weight initializations
     * that are needed for rendering the dialog such as resource allocations and asynchronous calls to fetch data. You
     ...
     * disposals in symmetric onBeforeOpen() and onAfterClose() events. If you allocate unmanaged resources in the
     ...
     *
     * @param options - Dialog showing options @see {@link IDialogShowOptions}
     */
