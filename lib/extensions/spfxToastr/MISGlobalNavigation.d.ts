export declare class MISGlobalNavigation {
    ...
    */
    private printTree(menuItem, nLevel);
    /**
    * Build the tree
    *
    */
    ...
    */
     ...
     *
     */
    private loadSessionStorage(spcontext);
    /**
     ...
     */
    init(spcontext: any, termStoreName: any, termSetId: any): void;
    private buildTermsModel(spcontext, termStoreName, termSetId);
}
/**
